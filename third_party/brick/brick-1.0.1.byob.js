/* http://mozilla.github.io/brick/download.html?byob=x-tag-core,brick-common,x-tag-appbar,x-tag-calendar,x-tag-transitions,x-tag-deck,x-tag-flipbox,x-tag-layout,x-tag-slider,x-tag-tabbar,x-tag-toggle */
window.Platform = {};
...
(function() {
    ...
    win.xtag = xtag;
    if (typeof define == "function" && define.amd) define('xtag', xtag);
